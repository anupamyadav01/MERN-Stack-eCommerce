...
const BannerBottom = () => {
  return (
    <div className="w-full bg-white border-b-[1px] py-4 border-b-gray-200 px-4">
      <div className="max-w-container mx-auto h-20 flex flex-col sm:flex-row justify-between items-center">
        {/* Two years warranty */}
        <div className="flex items-center gap-2 w-full sm:w-72 shadow-sm hover:shadow-md duration-300">
